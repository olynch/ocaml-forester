...
let expand_tree (units : exports Unit_map.t) (tree : Code.tree) =
  ...
  Builtins.register_builtins
    [
      ...
      ["author"; "content"], Syn.Attribution (Author, `Content);
      ["contributor"], Syn.Attribution (Contributor, `Iri);
      ["contributor"; "content"], Syn.Attribution (Contributor, `Content);
      ["parent"], Syn.Parent;
      ["number"], Syn.Number;
      ["tag"], Syn.Tag `Iri;
      ["tag"; "content"], Syn.Tag `Content;
      ["add-to-set"], Syn.Add_to_set;
      ["query"], Syn.Results_of_query;
      ["query"; "rel"], Syn.Query_rel `Iri;
      ["query"; "rel"; "content"], Syn.Query_rel `Content;
      ...
      ["query"; "taxon"], Syn.Query_builtin (`Taxon, `Iri);
      ["query"; "author"], Syn.Query_builtin (`Author, `Iri);
      ["query"; "tag"; "content"], Syn.Query_builtin (`Tag, `Content);
      ["query"; "taxon"; "content"], Syn.Query_builtin (`Taxon, `Content);
      ["query"; "author"; "content"], Syn.Query_builtin (`Author, `Content);
