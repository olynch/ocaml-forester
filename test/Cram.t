Run build:
  ...
  <fr:tree xmlns:fr="http://www.jonmsterling.com/jms-005P.xml" root="false">
    <fr:frontmatter>
      <fr:authors>
        <fr:author>
          <fr:link href="person.xml" title="Author Testington" addr="person" type="local">Author Testington</fr:link>
        </fr:author>
      </fr:authors>
      <fr:anchor>401</fr:anchor>
      <fr:addr type="user">hello</fr:addr>
      <fr:route>hello.xml</fr:route>
  ...
  <fr:tree xmlns:fr="http://www.jonmsterling.com/jms-005P.xml" root="false">
    <fr:frontmatter>
      ...
      <fr:addr type="user">nested</fr:addr>
      <fr:route>nested.xml</fr:route>
      <fr:title text="I am nested">I am nested</fr:title>
    </fr:frontmatter>
    <fr:mainmatter />
    <fr:backmatter>
      <fr:tree show-metadata="false" hidden-when-empty="true">
        <fr:frontmatter>
          <fr:anchor>402</fr:anchor>
          <fr:title text="References">References</fr:title>
        </fr:frontmatter>
        <fr:mainmatter />
      </fr:tree>
  ...
  <fr:tree xmlns:fr="http://www.jonmsterling.com/jms-005P.xml" root="false">
    <fr:frontmatter>
      ...
      <fr:addr type="user">person</fr:addr>
      <fr:route>person.xml</fr:route>
      <fr:title text="Author Testington">Author Testington</fr:title>
